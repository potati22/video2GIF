...
function N(r) {
  ...
  var n = te(t),
    s = {
      ...
      amazon: { phone: n(b), tablet: !n(b) && n(A), device: n(b) || n(A) },
      android: {
        phone: (!n(g) && n(b)) || (!n(g) && n(k)),
        tablet: !n(g) && !n(b) && !n(k) && (n(A) || n(H)),
        device: (!n(g) && (n(b) || n(A) || n(k) || n(H))) || n(/\bokhttp\b/i),
      },
      windows: { phone: n(g), tablet: n(R), device: n(g) || n(R) },
      other: {
        blackberry: n(X),
        blackberry10: n(F),
        opera: n(Y),
...
class V {
  ...
  init(e) {
    ;(this.debug = (e == null ? void 0 : e.debug) ?? this.debug),
      this._renderer.runners.postrender.remove(this)
  }
  postrender() {
    ...
    const {
      ...
      { width: o, height: a, resolution: c } = this._renderer,
      p = (n / o) * c,
      v = (s / a) * c
    let h = this._div
    ;(h.style.left = `${t}px`),
    ...
    for (let l = 0; l < this._children.length; l++) {
      ...
      if (u._renderId !== this._renderId)
        ...
        u.hitArea
          ? ((h.style.left = `${(_.tx + d.x * _.a) * p}px`),
            (h.style.top = `${(_.ty + d.y * _.d) * v}px`),
            (h.style.width = `${d.width * _.a * p}px`),
            (h.style.height = `${d.height * _.d * v}px`))
          : ((d = u.getBounds().rectangle),
            this._capHitArea(d),
            (h.style.left = `${d.x * p}px`),
            (h.style.top = `${d.y * v}px`),
            (h.style.width = `${d.width * p}px`),
            (h.style.height = `${d.height * v}px`),
            h.title !== u.accessibleTitle &&
              u.accessibleTitle !== null &&
              (h.title = u.accessibleTitle || ''),
            h.getAttribute('aria-label') !== u.accessibleHint &&
              u.accessibleHint !== null &&
              h.setAttribute('aria-label', u.accessibleHint || '')),
          (u.accessibleTitle !== h.title || u.tabIndex !== h.tabIndex) &&
            ((h.title = u.accessibleTitle || ''),
            (h.tabIndex = u.tabIndex),
...
V.extension = { type: [w.WebGLSystem, w.WebGPUSystem], name: 'accessibility' }
const ue = {
  accessible: !1,
...
class de {
  ...
  addTickerListener() {
    this._tickerAdded ||
      !this.domElement ||
      (B.system.add(this._tickerUpdate, this, J.INTERACTION),
      (this._tickerAdded = !0))
  }
  removeTickerListener() {
    this._tickerAdded &&
      (B.system.remove(this._tickerUpdate, this), (this._tickerAdded = !1))
  }
  pointerMoved() {
    this._didMove = !0
  }
...
class ve {
  ...
  hitTestMoveRecursive(e, t, i, n, s, o = !1) {
    ...
    if (
      ((e.eventMode === 'dynamic' || t === 'dynamic') && (E.pauseUpdate = !1),
      ...
      for (let h = v.length - 1; h >= 0; h--) {
        ...
        if (u) {
          ...
          ;(u.length > 0 || d) &&
            (d && this._allInteractiveElements.push(e), u.push(e)),
  ...
  mapPointerMove(e) {
    ...
    if (
      ((c = n.overTargets) == null ? void 0 : c.length) > 0 &&
      s !== t.target
    ) {
      const v = e.type === 'mousemove' ? 'mouseout' : 'pointerout',
        h = this.createPointerEvent(e, v, s)
      if (
        (this.dispatchEvent(h, 'pointerout'),
        ...
        for (
          ...
          l.target && !t.composedPath().includes(l.target);
    ...
    if (s !== t.target) {
      const v = e.type === 'mousemove' ? 'mouseover' : 'pointerover',
        h = this.clonePointerEvent(t, v)
      ...
      if (!l || l === this.rootTarget.parent) {
        ...
        for (
          ...
          d.target && d.target !== s && d.target !== this.rootTarget.parent;
    ...
    this.moveOnAll
      ...
      i &&
        ...
        (this.cursor = (p = t.target) == null ? void 0 : p.cursor)),
  ...
  mapPointerUp(e) {
    ...
    if (o) {
      ...
      if (
        (c.target === a.target && t - c.timeStamp < 200
          ? ++c.clickCount
          : (c.clickCount = 1),
        (c.target = a.target),
        (c.timeStamp = t),
...
L.defaultEventFeatures = { move: !0, globalMove: !0, click: !0, wheel: !0 }
let q = L
const me = {
  onclick: null,
  onmousedown: null,
