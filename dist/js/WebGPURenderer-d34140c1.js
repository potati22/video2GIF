...
class O {
  init() {
    const e = T({ name: 'batch', bits: [L, z(R), C] })
...
class $ {
  constructor() {
    ;(this.defaultState = new D()), (this.defaultState.blend = !0)
  }
  contextChange(e) {
    this.gpu = e
  }
...
const De = {
  ...
  Le = { blockBytes: 4, blockWidth: 1, blockHeight: 1 },
  ze = {
    type: 'compressed',
    upload(a, e, t) {
      let r = a.pixelWidth,
        s = a.pixelHeight
      const i = X[a.format] || Le
...
class J {
  constructor(e) {
    ;(this.managedTextures = []),
      ...
      (this._uploads = { image: Q, buffer: De, video: Oe, compressed: ze }),
      (this._renderer = e)
  }
  contextChange(e) {
    this._gpu = e
...
J.extension = { type: [l.WebGPUSystem], name: 'texture' }
class Z {
  init() {
    const e = new pe({
      ...
      t = T({ name: 'graphics', bits: [L, z(R), le, C] })
...
const Fe = [...Pe, N, W, U, F, J, q, Y, $, K, I, V, H],
  Ie = [...Te, j],
  We = [O, ee, Z],
  te = [],
  re = [],
