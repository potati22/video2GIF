...
const q = (e) => {
  ...
  pe = (e) => {
    g(() => {
      E.length === 0 && document.addEventListener('keydown', q), H && E.push(e)
    }),
      N(() => {
        ;(E = E.filter((n) => n !== e)),
          E.length === 0 && H && document.removeEventListener('keydown', q)
      })
  },
  w = 'focus-trap.focus-after-trapped',
  L = 'focus-trap.focus-after-released',
  me = 'focus-trap.focusout-prevented',
  G = { cancelable: !0, bubbles: !1 },
  Te = { cancelable: !0, bubbles: !1 },
  J = 'focusAfterTrapped',
  W = 'focusAfterReleased',
