...
function Xe(i, e) {
  ...
  let r = e
  if (((i.isRenderGroupRoot || t) && (r = Z.get().clear()), i.boundsArea))
  ...
  if (t) {
    ...
    i.isRenderGroupRoot &&
      (e.addBounds(r, i.relativeGroupTransform), Z.return(r))
}
function Wt(i, e) {
  e.clear()
  const t = e.matrix
...
class N extends bt {
  constructor(e) {
    ...
    super({ label: 'Graphics', ...s }),
      ...
      (this._roundPixels = 0),
      t ? (this._context = t) : (this._context = this._ownedContext = new E()),
  ...
  endFill() {
    ...
    return (
      (e.width !== E.defaultStrokeStyle.width ||
        e.color !== E.defaultStrokeStyle.color ||
        e.alpha !== E.defaultStrokeStyle.alpha) &&
        this.context.stroke(),
      this
    )
  }
...
function q(i, e) {
  ...
  return L('FillStyle not recognised', i), 'red'
}
class Ke extends wt {
  constructor() {
    super(...arguments),
...
` &&
  ...
  _nextPage() {
    ...
    const e = this.resolution,
      t = W.getOptimalCanvasAndContext(512, 512, e)
  ...
  destroy() {
    ...
    for (let e = 0; e < this.pages.length; e++) {
      ...
      W.returnCanvasAndContext(t), r.destroy(!0)
    }
    this.pages = null
  }
}
...
class he extends $ {
  ...
  set fill(e) {
    typeof e != 'string' &&
      typeof e != 'number' &&
      L('[HTMLTextStyle] only color fill is not supported by HTMLText'),
      (super.fill = e)
  }
  set stroke(e) {
    e &&
      typeof e != 'string' &&
      typeof e != 'number' &&
      L('[HTMLTextStyle] only color stroke is not supported by HTMLText'),
      (super.stroke = e)
  }
}
...
class Qt extends ze {
  constructor() {
    te ?? (te = He({ name: 'tiling-sprite-shader', bits: [Ft, Nt, We] })),
      re ?? (re = Ie({ name: 'tiling-sprite-shader', bits: [Rt, qt, Oe] }))
    const e = new Y({
...
class cr extends ze {
  constructor() {
    const e = new Y({
      ...
      t = He({ name: 'sdf-shader', bits: [kt, Ut(me), nr, or, We] }),
      r = Ie({ name: 'sdf-shader', bits: [At, Gt(me), ar, lr, Oe] })
    super({
      glProgram: r,
      gpuProgram: t,
...
function xr(i, e) {
  const t = W.getOptimalCanvasAndContext(i.width, i.height, e),
    { context: r } = t
  return (
    r.clearRect(0, 0, i.width, i.height),
    r.drawImage(i, 0, 0),
    W.returnCanvasAndContext(t),
    t.canvas
  )
}
function mr(i, e, t) {
...
class ft {
  ...
  createTextureAndCanvas(e) {
    const { text: t, style: r } = e,
      ...
      l = W.getOptimalCanvasAndContext(a, o),
      { canvas: h } = l
  ...
  decreaseReferenceCount(e) {
    ...
    if ((t.usageCount--, t.usageCount === 0)) {
      W.returnCanvasAndContext(t.canvasAndContext), A.returnTexture(t.texture)
  ...
  renderTextToCanvas(e, t, r, s) {
    ...
    for (let M = 0; M < _; ++M) {
      const z = t.dropShadow && M === 0,
        O = z ? Math.ceil(Math.max(1, p) + t.padding * 2) : 0,
        Q = O * r
      if (z) {
