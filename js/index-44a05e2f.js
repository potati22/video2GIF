                        ...
                        f.$slots.loading
                          ...
                          : (S(),
                            W(
                              ...
                              {
                                default: V(() => [(S(), W(_e(f.loadingIcon)))]),
                                _: 1,
                              },
                              8,
                              ['class'],
...
var _t = q(Ba, [['__file', 'button-group.vue']])
...
const za = Fe({
  ...
  Ua = {
    [Be]: (e) => Se(e) || $e(e),
    [ia]: (e) => Se(e) || $e(e),
    activeChange: (e) => Se(e) || $e(e),
    focus: (e) => e instanceof FocusEvent,
    blur: (e) => e instanceof FocusEvent,
  },
  St = Symbol('colorPickerContextKey'),
  st = function (e, a, t) {
  ...
  He = { A: 10, B: 11, C: 12, D: 13, E: 14, F: 15 },
  K = function (e) {
    return e.length === 2
      ? (He[e[0].toUpperCase()] || +e[0]) * 16 +
          (He[e[1].toUpperCase()] || +e[1])
      : He[e[1].toUpperCase()] || +e[1]
  },
  Ga = function (e, a, t) {
    ;(a = a / 100), (t = t / 100)
    ...
    setup(e, { expose: a, emit: t }) {
      const n = e,
        ...
        E = y(),
        {
          ...
          beforeBlur(h) {
            var M
            return (M = v.value) == null ? void 0 : M.isFocusInsideContent(h)
          },
          afterBlur() {
            Q(!1), ee()
          },
      ...
      function Et() {
        ...
        t(Be, h),
          t('change', h),
          n.validateEvent &&
            (s == null || s.validate('change').catch((M) => Je())),
          se(!1),
          ie(() => {
            const M = new ne({
              enableAlpha: n.showAlpha,
      ...
      function Bt(h) {
        if (Z.value && (Le(), P.value)) {
          const M = new FocusEvent('focus', h)
          m(M)
        }
      }
      function Oe(h) {
          ...
          () => {
            ie(() => {
              ...
              ;(h = d.value) == null || h.update(),
                (M = _.value) == null || M.update(),
                (I = f.value) == null || I.update()
            })
          },
        ),
        dt(St, { currentColor: ke }),
