...
import { b as ee } from './batchSamplersUniformGroup-913fcf01.js'
import {
  e as ye,
  G as Ce,
  c as Ge,
...
class re {
  ...
  init(e) {
    const r = O({ name: 'batch', bits: [q, Z($), P] })
    ;(this._shader = new x({ glProgram: r, resources: { batchSamplers: ee } })),
...
class se {
  ...
  createGLBuffer(e) {
    ...
    e.descriptor.usage & A.INDEX
      ...
      : e.descriptor.usage & A.UNIFORM && (s = T.UNIFORM_BUFFER)
...
const M = class ne {
  ...
  initFromContext(e) {
    ;(this.gl = e),
      (this.webGLVersion =
        e instanceof G.get().getWebGLRenderingContext() ? 1 : 2),
      this.getExtensions(),
    ...
    for (const c in i) {
      ...
      if (d) {
        ...
        if (
          ...
          if (this.hasInstance) s.vertexAttribDivisor(m, 1)
          else
            throw new Error(
...
const Xe = new Be({ attributes: { aPosition: [-1, -1, 3, -1, -1, 3] } }),
  L = class oe {
    constructor(e) {
...
function ze(t) {
  return Ge(t, 'uboStd40', $e, Ue)
}
class he extends Oe {
  constructor() {
    super({ createUboElements: Ke, generateUboSync: ze })
  }
}
...
function nt(t, e) {
  ...
  i &&
    ...
    t.linkProgram(n),
    t.getProgramParameter(n, t.LINK_STATUS) || st(t, n, r, s),
    (e._attributeData = et(
      n,
      t,
      !/^[ \t]*#[ \t]*version[ \t]+300[ \t]+es[ \t]*$/m.test(e.vertex),
    )),
    (e._uniformData = rt(n, t)),
...
class Ee {
  ...
  _createProgramData(e) {
    const r = e._key
    return (
      (this._programDataHash[r] = nt(this._gl, e)), this._programDataHash[r]
    )
  }
  destroy() {
...
function ot(t, e) {
  ...
  for (const s in t.uniforms) {
    ...
    if (!i) {
      const o = (n.size === 1 ? it : at)[n.type].replace(
        'location',
        `ud["${s}"].location`,
      )
      r.push(`
  ...
  Se = class C {
    constructor() {
      ;(this.gl = null),
        ...
        (this._blendEq = !1),
        (this.map = []),
        (this.map[ut] = this.setBlend),
        (this.map[_t] = this.setOffset),
        (this.map[ft] = this.setCullFace),
        (this.map[ht] = this.setDepthTest),
        (this.map[lt] = this.setFrontFace),
        (this.map[dt] = this.setDepthMask),
        (this.checks = []),
...
function K(t, e, r, s, n, i, a, o) {
  ...
  if (
    ...
    if (!o || t.mipmapFilter !== 'linear') {
      const u = Rt[t.minFilter][t.mipmapFilter]
...
function xt(t, e) {
  let r = {},
    s = t.RGBA
  return (
    t instanceof G.get().getWebGLRenderingContext()
      ? e.srgb &&
        (r = {
...
class pe {
  constructor(e) {
    ;(this.managedTextures = []),
      ...
      (this._uploads = { image: ge, buffer: bt, video: pt, compressed: gt }),
  ...
  contextChange(e) {
    ;(this._gl = e),
      this._mapFormatToInternalFormat ||
        ((this._mapFormatToInternalFormat = xt(
          e,
          this._renderer.context.extensions,
        )),
        (this._mapFormatToType = At(e)),
        (this._mapFormatToFormat = vt(e))),
      (this._glTextures = Object.create(null)),
      (this._glSamplers = Object.create(null)),
      (this._boundSamplers = Object.create(null))
...
class Re {
  init() {
    const e = new F({
      ...
      r = O({ name: 'graphics', bits: [q, Z($), J, P] })
    this.shader = new x({
      glProgram: r,
      resources: { localUniforms: e, batchSamplers: ee },
    })
  }
  execute(e, r) {
    const s = r.context,
...
class Te {
  init() {
    const e = O({ name: 'mesh', bits: [J, Fe, P] })
    this._shader = new x({
      glProgram: e,
      resources: {
...
const Nt = [...Me, he, We, we, se, pe, le, ae, be, Ee, ue, mt, _e, ce],
  It = [...Le],
  Dt = [re, Te, Re],
  ve = [],
  xe = [],
...
v.handleByNamedList(l.WebGLPipesAdaptor, Ae)
v.add(...Nt, ...It, ...Dt)
class Ot extends Ne {
  constructor() {
    const e = {
