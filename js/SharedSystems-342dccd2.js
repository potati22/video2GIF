...
class Xe extends Ye {
  constructor(e) {
    const { sprite: t, ...r } = e,
      ...
      l = te.from({ vertex: Qe, fragment: Je, name: 'mask-filter' })
    super({
      ...r,
      gpuProgram: i,
      glProgram: l,
...
function P(s, e, t) {
  s.globalDisplayStatus < 7 ||
    ...
    s.isSimple ? et(s, e, t) : ie(s, e, t, !1))
}
function et(s, e, t) {
  if (
    (s.renderPipeId &&
...
function ie(s, e, t, r) {
  if (!r && s.isRenderGroupRoot) t.renderGroup.addRenderGroup(s.renderGroup, e)
  else {
...
class rt extends K {
  constructor() {
    super({ filters: [new Xe({ sprite: new Ie(m.EMPTY) })] })
  }
  get sprite() {
...
const T = []
T[p.NONE] = void 0
T[p.DISABLED] = { stencilWriteMask: 0, stencilReadMask: 0 }
...
function Pt(s, e, t, r) {
  ...
  for (let l = 0; l < s.length; l++) {
    ...
    for (let f = 0; f < M.length; f++)
      if (M[f].test(o.data)) {
        ;(h = o.offset / 4),
          a.push(`name = "${d}";`, `offset += ${h - n};`, M[f][e] || M[f].ubo),
          (c = !0)
        break
      }
    if (!c)
  ...
  constructor(e = {}) {
    ...
    this.colorTexture.source.on('resize', this.onSourceResize, this),
      (e.depthStencilTexture || this.stencil) &&
        ...
        e.depthStencilTexture instanceof _
...
class Gt {
  constructor(e) {
    ;(this.rootViewPort = new w()),
      (this.viewport = new w()),
      (this.onRenderTargetChange = new De('onRenderTargetChange')),
  ...
  renderStart({ target: e, clear: t, clearColor: r, frame: a }) {
    ;(this._renderTargetStack.length = 0),
      ...
      (this.renderingToScreen = it(this.rootRenderTarget))
  }
  bind(e, t = !0, r, a) {
...
const R = 16777215
function xe(s, e) {
  return s === R || e === R ? s + e - R : ot(s, e, 0.5)
}
const lt = new S()
function ve(s, e = !1) {
  ut(s)
...
function ut(s) {
  ...
  if (s.renderGroupParent) {
    ...
    s.worldTransform.appendFrom(e.relativeGroupTransform, r.worldTransform),
      (s.worldColor = xe(e.groupColor, r.worldColor)),
...
function j(s, e, t) {
  if (t & Oe) {
    s.groupColor = xe(s.localColor, e.groupColor)
  ...
  render({ container: e, transform: t }) {
    ...
    for (let d = 0; d < i.length; d++) {
      ...
      c.runOnRender(),
        ...
        c.structureDidChange || dt(c, o),
        ve(c),
        c.structureDidChange ? ((c.structureDidChange = !1), Ze(c, o)) : ht(c),
...
class ke {
  ...
  _beginAdvancedBlendMode(e) {
    ...
    this._filterHash[t] ||
      (this._filterHash[t] = new K({ filters: [new y[t]()] }))
    const r = {
      renderPipeId: 'filter',
      action: 'pushFilter',
      renderables: [],
...
const G = { png: 'image/png', jpg: 'image/jpeg', webp: 'image/webp' },
  D = class Me {
    constructor(e) {
      this._renderer = e
    }
    ...
    async base64(e) {
      ...
      if (a.toDataURL !== void 0) return a.toDataURL(G[t], r)
      if (a.convertToBlob !== void 0) {
        const n = await a.convertToBlob({ type: G[t], quality: r })
...
D.extension = { type: [u.WebGLSystem, u.WebGPUSystem], name: 'extract' }
D.defaultImageOptions = { format: 'png', quality: 1 }
let pt = D
class mt extends m {
  static create(e) {
    return new m({ source: new _(e) })
  }
  resize(e, t, r) {
    ...
    n
      ? (n =
          Array.isArray(n) && n.length === 4
            ? n
            : J.shared.setValue(n).toArray())
      : (n = vt)
    const i =
      ((d = e.frame) == null ? void 0 : d.copyTo(gt)) || Le(a, xt).rectangle
...
class we {
  ...
  bind({
    ...
    this._renderer.renderPipes.uniformBatch
      ...
      : ((h = this._bindGroupPool.pop() || new Ve()),
...
const z = class Re {
  ...
  init(e) {
    ;(e = { ...Re.defaultOptions, ...e }),
      e.view &&
        (je($e, 'ViewSystem.view has been renamed to ViewSystem.canvas'),
        (e.canvas = e.view)),
      (this.screen = new w(0, 0, e.width, e.height)),
      (this.canvas = e.canvas || X.get().createCanvas()),
      (this.antialias = !!e.antialias),
...
let _t = z
const Ut = [ft, we, E, _t, _e, Pe, Ce, pt],
  At = [ke, ne, ye, me, oe, ue, le, fe]
export {
  Bt as B,
  T as G,
  Gt as R,
